...
import com.example.davidprados.pokedex.adaptadores.PokemonAdapter;
...
public class Fragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_fragment3, container,false);

        recyclerPokemon = vista.findViewById(R.id.recView);
        adapter = new PokemonAdapter(getContext());
    ...
    private void obtenerGeneracion(){
        ...
        Call<PokemonRespuesta> call = service.obtenerListaPokemon(135,251);
